...
*/
    ...
    if (!wipe)
    {
	I_FinishUpdate (1);              // page flip or blit buffer
	return;
    }
...
//    char            demolumpname[9];
    ...
    FILE *fprw = fopen("./pspdoom.wad","rb");
...
*/
	    ...
	    fsize == 4196020)		// DOOM SHAREWARE v1.8
    {
    	...
    	printf("                     DOOM System Startup v1.4                     ");
...
//    InitGameVersion();
	...
	while(1)
	{
	    ...
	    printf(" ================================================================== ");
	    printf("  ATTENTION:  This version of DOOM has been modified. If you would\n");
	    printf(" like to get a copy of the original game, call 1-800-IDGAMES or see\n");
	    printf("    the readme file.  You will not receive technical support for\n");
	    printf("              modified games.  press enter to continue\n");
	    printf(" ================================================================== ");
...
static void CreateSavePath(void)
{
    ...
    char creationRoot4[121];
    char creationRoot5[121];
    char creationRoot6[121];
    char creationRoot7[121];
    char creationRoot8[121];

    strcpy(creationRoot1, SavePathRoot1);
    strcpy(creationRoot2, SavePathRoot2);
    strcpy(creationRoot3, SavePathRoot3);
    strcpy(creationRoot4, SavePathRoot4);
    strcpy(creationRoot5, SavePathRoot5);
    strcpy(creationRoot6, SavePathRoot6);
    strcpy(creationRoot7, SavePathRoot7);
    strcpy(creationRoot8, SavePathRoot8);
...
//    creationRoot[120] = 0;
    ...
    mkdir( creationRoot4, S_IRWXU|S_IRWXG|S_IRWXO );
    mkdir( creationRoot5, S_IRWXU|S_IRWXG|S_IRWXO );
    mkdir( creationRoot6, S_IRWXU|S_IRWXG|S_IRWXO );
    mkdir( creationRoot7, S_IRWXU|S_IRWXG|S_IRWXO );
    mkdir( creationRoot8, S_IRWXU|S_IRWXG|S_IRWXO );

    if (fsize == 4261144)
	strcpy(creationPath, SavePathBeta14);
    else if (fsize == 4271324)
	strcpy(creationPath, SavePathBeta15);
    else if (fsize == 4211660)
	strcpy(creationPath, SavePathBeta16);
    else if(fsize == 4207819)
	strcpy(creationPath, SavePathShare10);
    else if(fsize == 4274218)
	strcpy(creationPath, SavePathShare11);
    else if(fsize == 4225504)
	strcpy(creationPath, SavePathShare12);
    else if(fsize == 4225460)
	strcpy(creationPath, SavePathShare125);
    else if(fsize == 4234124)
	strcpy(creationPath, SavePathShare1666);
    else if(fsize == 4196020)
	strcpy(creationPath, SavePathShare18);
    else if(fsize == 10396254)
	strcpy(creationPath, SavePathReg11);
    else if(fsize == 10399316)
	strcpy(creationPath, SavePathReg12);
    else if(fsize == 10401760)
	strcpy(creationPath, SavePathReg16);
    else if(fsize == 11159840)
	strcpy(creationPath, SavePathReg18);
    else if(fsize == 12408292)
	strcpy(creationPath, SavePathReg19);
    else if (fsize == 14943400)
	strcpy(creationPath, SavePath2Reg1666);
    else if (fsize == 14824716)
	strcpy(creationPath, SavePath2Reg1666G);
    else if (fsize == 14612688)
	strcpy(creationPath, SavePath2Reg17);
    else if (fsize == 14607420)
	strcpy(creationPath, SavePath2Reg18F);
    else if (fsize == 14604584)
	strcpy(creationPath, SavePath2Reg19);
    else if (fsize == 18195736)
	strcpy(creationPath, SavePathTNT191);
    else if (fsize == 18654796)
	strcpy(creationPath, SavePathTNT192);
    else if (fsize == 18240172)
	strcpy(creationPath, SavePathPLUT191);
    else if (fsize == 17420824)
	strcpy(creationPath, SavePathPLUT192);
    else if (fsize == 12361532)
	strcpy(creationPath, SavePathChex);
/*
    else if (fsize == 9745831)
	strcpy(creationPath, SavePathHacxShare10);
    else if (fsize == 21951805)
	strcpy(creationPath, SavePathHacxReg10);
    else if (fsize == 22102300)
	strcpy(creationPath, SavePathHacxReg11);
*/
    else if (fsize == 19321722)
	strcpy(creationPath, SavePathHacxReg12);
/*
    else if(fsize == 19801320)
	strcpy(creationPath, SavePathFreedoom064);
    else if(fsize == 27704188)
	strcpy(creationPath, SavePathFreedoom07RC1);
    else if(fsize == 27625596)
	strcpy(creationPath, SavePathFreedoom07);
    else if(fsize == 28144744)
	strcpy(creationPath, SavePathFreedoom08B1);
    else if(fsize == 28592816)
	strcpy(creationPath, SavePathFreedoom08);
    else if(fsize == 19362644)
	strcpy(creationPath, SavePathFreedoom08P1);
*/
    else if(fsize == 28422764)
	strcpy(creationPath, SavePathFreedoom08P2);
