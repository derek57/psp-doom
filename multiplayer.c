...
boolean respawnflag;
boolean warpflag;
boolean multiplayerflag;
boolean deathmatchflag;
...
*/
	    ...
	    fsize == 17420824)
    {
        ...
        new_warptype = WARP_NOT_SELECTED;
